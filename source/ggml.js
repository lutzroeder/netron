...
ggml.Model = class {
    ...
    constructor(target) {
        ...
        this.graphs = [ new ggml.Graph(graph) ];
    }
};
...
ggml.Graph = class {
    ...
    constructor(graph) {
        ...
        for (const layer of graph.layers) {
            const node = new ggml.Node(layer);
...
ggml.Node = class {
    ...
    constructor(layer) {
        this.type = Array.isArray(layer.layers) && layer.layers.length > 0 ? new ggml.Graph(layer) : { name: layer.type };
