...
def metadata():
    json_file = join(dirname(__file__), '../source/nnabla-metadata.json')
    yaml_functions = join(dirname(__file__), '../third_party/source/nnabla/build-tools/code_generator/functions.yaml')
...
def proto():
    base = abspath(join(dirname(__file__), '../third_party/source/nnabla'))
    tmpl_file = join(base, 'src/nbla/proto/nnabla.proto.tmpl')
    yaml_functions = join(base, 'build-tools/code_generator/functions.yaml')
    yaml_solvers = join(base, 'build-tools/code_generator/solvers.yaml')
